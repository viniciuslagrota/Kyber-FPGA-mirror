...
//
//////////////////////////////////////////////
void smw3000GetControlStruct(smControlStruct * psmControlStruct)
{
	*psmControlStruct = smControl;
}
...
{
	print_debug(DEBUG_UART_LVL1, "RX Buffer (len %d): ", smBuffer.u32RxBufferLen);
