...
begin
    ...
    begin
        if(rising_edge(clk)) then
            ...
            s_valid_in_0    <= valid_in_0;
            s_data_in_0     <= data_in_0;
            s_enable_in_1   <= enable_in_1;
            s_valid_in_1    <= valid_in_1;
            s_data_in_1     <= data_in_1;            
        end if;
    end process;
    
    valid_out <= s_valid_in_0 when s_enable_in_0 = '1' else
                 s_valid_in_1 when s_enable_in_1 = '1' else
                 '0';
