                ...
                if(s_start = '1') then   
                    ...
                    if(s_kyber_k_it(13) < unsigned(s_kyber_k)) then
                        if(s_valid0_from_barrett(3) = '1') then
                            s_bram_wea <= '1';                                    
                            s_bram_addra <= "0" & std_logic_vector(s_kyber_k_it(13)) & std_logic_vector(s_j(13) + s_length(13));
                            s_bram_dia   <= s_coeff_from_fqmul1(0) & s_coeff_from_fqmul0(0);
                        else                          
                            s_bram_wea <= '0';                                    
                ...
                if(s_start = '1') then                       
                    ...
                    if(s_kyber_k_it(13) < unsigned(s_kyber_k)) then
                        if(s_valid1_from_barrett(3) = '1') then
                            s_bram_web   <= '1';         
                            s_bram_addrb <= "0" & std_logic_vector(s_kyber_k_it(13)) & std_logic_vector(s_j(13));               
                            s_bram_dib   <= s_data1_from_barrett(3) & s_data0_from_barrett(3);
                        else
                            s_bram_web   <= '0';         
