...
HD_PWD='C:/Projects/kyber-fpga/kyber-fpga.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log kyberBD_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source kyberBD_wrapper.tcl
