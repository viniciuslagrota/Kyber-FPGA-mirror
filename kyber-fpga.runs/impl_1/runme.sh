...
HD_PWD='C:/Projects/kyber-fpga/kyber-fpga.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log kyberBD_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source kyberBD_wrapper.tcl -notrace
