...
HD_PWD='c:/projects/kyber-fpga/kyber-fpga.tmp/poly_tomont_v1_0_project/poly_tomont_v1_0_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log poly_tomont_v1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source poly_tomont_v1_0.tcl
