...
HD_PWD='c:/projects/kyber-fpga/kyber-fpga.tmp/bram_port_selector_v1_0_project/bram_port_selector_v1_0_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bram_port_selector_v1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bram_port_selector_v1_0.tcl
