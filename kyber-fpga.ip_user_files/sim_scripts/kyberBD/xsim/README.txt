...
#
# Generated by export_simulation on Sat Feb 20 20:21:47 -0300 2021
#
################################################################################
...
'-reset_run' switch to the './kyberBD.sh' script.

./kyberBD.sh -reset_run
...
./kyberBD.sh -noclean_files

For more information on the script, please type './kyberBD.sh -help'.
