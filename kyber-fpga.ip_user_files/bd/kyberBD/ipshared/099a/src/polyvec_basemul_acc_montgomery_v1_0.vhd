...
--                if(or_reduce(s_en_vec(8 downto 1)) = '1') then
                if(or_reduce(s_en_vec(12 downto 1)) = '1') then
                    if(s_counter = 3) then
                        s_counter <= (others => '0'); 
        ...
        if(rising_edge(clk)) then
            if aresetn = '0' then     
                ...
                if(start = '1') then
                    ...
                    s_valid_to_fqmul1 <= s_en_vec(5);
                    s_valid_to_fqmul2 <= s_en_vec(9);                  
